...
} from '../js/modules/core/transaction-classification.js';
...
// Helper to build a full Transaction with sensible defaults
function tx(overrides: Partial<Transaction> & { type: string; amount: number; date: string; category: string }): Transaction {
  return {
...
describe('calcVelocityPure', () => {
  const transactions: Transaction[] = [
    tx({ type: 'expense', amount: 100, date: '2024-06-01', category: 'food' }),
    tx({ type: 'expense', amount: 200, date: '2024-06-15', category: 'transport' }),
    tx({ type: 'expense', amount: 150, date: '2024-06-20', category: 'shopping' }),
    tx({ type: 'income', amount: 3000, date: '2024-06-01', category: 'salary' })
  ];
  ...
  it('handles month with only income', () => {
    const incomeOnly: Transaction[] = [
      tx({ type: 'income', amount: 5000, date: '2024-06-01', category: 'salary' })
    ];
...
describe('getYearStatsPure', () => {
  const transactions: Transaction[] = [
    tx({ type: 'income', amount: 5000, date: '2024-01-15', category: 'salary' }),
    tx({ type: 'income', amount: 5000, date: '2024-06-15', category: 'salary' }),
    tx({ type: 'expense', amount: 1000, date: '2024-01-20', category: 'rent' }),
    tx({ type: 'expense', amount: 500, date: '2024-02-10', category: 'food' }),
    tx({ type: 'expense', amount: 300, date: '2024-03-05', category: 'transport' }),
    tx({ type: 'expense', amount: 200, date: '2024-04-01', category: 'shopping' }),
    // Different year
    tx({ type: 'income', amount: 4000, date: '2023-12-15', category: 'salary' })
  ];
  ...
  it('handles year with only expenses', () => {
    const expenseOnly: Transaction[] = [
      tx({ type: 'expense', amount: 500, date: '2024-01-01', category: 'food' })
    ];
  ...
  it('excludes savings transfers from yearly expense analytics', () => {
    const result = getYearStatsPure([
      tx({ type: 'income', amount: 5000, date: '2024-01-15', category: 'salary' }),
      tx({ type: 'expense', amount: 600, date: '2024-01-20', category: 'food' }),
      tx({
        type: 'expense',
        amount: 400,
        date: '2024-01-21',
    ...
    expect(result.net).toBe(4400);
    expect(result.topCategories).toEqual([{ id: 'food', amount: 600 }]);
  });
});
...
describe('getAllTimeStatsPure', () => {
  const transactions: Transaction[] = [
    tx({ type: 'income', amount: 5000, date: '2023-01-15', category: 'salary' }),
    tx({ type: 'income', amount: 5500, date: '2024-06-15', category: 'salary' }),
    tx({ type: 'expense', amount: 2000, date: '2023-06-01', category: 'rent' }),
    tx({ type: 'expense', amount: 1500, date: '2024-03-15', category: 'shopping' })
  ];
  ...
  it('handles transactions without dates', () => {
    const mixed: Transaction[] = [
      tx({ type: 'income', amount: 1000, date: '2024-01-01', category: 'salary' }),
      tx({ type: 'expense', amount: 500, date: '', category: 'food' }) // Empty date
    ];
...
describe('Floating-point precision', () => {
  it('handles classic 0.1 + 0.2 precision issue', () => {
    ...
    const transactions: Transaction[] = [
      tx({ type: 'expense', amount: 0.1, date: '2024-06-01', category: 'food' }),
      tx({ type: 'expense', amount: 0.2, date: '2024-06-02', category: 'food' })
    ];
  ...
  it('handles mixed decimals accurately', () => {
    const transactions: Transaction[] = [
      tx({ type: 'income', amount: 1234.56, date: '2024-06-01', category: 'salary' }),
      tx({ type: 'income', amount: 789.01, date: '2024-06-02', category: 'bonus' }),
      tx({ type: 'income', amount: 0.43, date: '2024-06-03', category: 'interest' })
    ];
  ...
  it('handles year stats with precision-sensitive amounts', () => {
    const transactions: Transaction[] = [
      tx({ type: 'expense', amount: 33.33, date: '2024-01-01', category: 'food' }),
      tx({ type: 'expense', amount: 33.33, date: '2024-02-01', category: 'food' }),
      tx({ type: 'expense', amount: 33.34, date: '2024-03-01', category: 'food' })
    ];
    const result = getYearStatsPure(transactions, '2024');
  ...
  it('handles net calculations without precision loss', () => {
    const transactions: Transaction[] = [
      tx({ type: 'income', amount: 1000.00, date: '2024-01-01', category: 'salary' }),
      tx({ type: 'expense', amount: 333.33, date: '2024-01-02', category: 'rent' }),
      tx({ type: 'expense', amount: 333.33, date: '2024-01-03', category: 'food' }),
      tx({ type: 'expense', amount: 333.34, date: '2024-01-04', category: 'transport' })
    ];
    const result = getYearStatsPure(transactions, '2024');
...
describe('Edge cases - amounts', () => {
  it('handles zero amounts in calculations', () => {
    const txWithZero: Transaction[] = [
      tx({ type: 'expense', amount: 0, date: '2024-06-01', category: 'food' }),
      tx({ type: 'expense', amount: 100, date: '2024-06-02', category: 'food' })
    ];
  ...
  it('handles MAX_AMOUNT values', () => {
    const maxAmountTx: Transaction[] = [
      tx({ type: 'income', amount: CONFIG.MAX_AMOUNT, date: '2024-06-01', category: 'salary' })
    ];
  ...
  it('handles very small amounts (MIN_AMOUNT)', () => {
    const minAmountTx: Transaction[] = [
      tx({ type: 'expense', amount: CONFIG.MIN_AMOUNT, date: '2024-06-01', category: 'food' }),
      tx({ type: 'expense', amount: CONFIG.MIN_AMOUNT, date: '2024-06-02', category: 'food' })
    ];
  ...
  it('handles string amounts (legacy data)', () => {
    const stringAmounts: Transaction[] = [
      tx({ type: 'expense', amount: '100.50' as unknown as number, date: '2024-06-01', category: 'food' }),
      tx({ type: 'income', amount: '500' as unknown as number, date: '2024-06-01', category: 'salary' })
    ];
  ...
  it('handles NaN amounts gracefully', () => {
    const badAmounts: Transaction[] = [
      tx({ type: 'expense', amount: NaN, date: '2024-06-01', category: 'food' }),
      tx({ type: 'expense', amount: 100, date: '2024-06-02', category: 'food' })
    ];
...
describe('Export/Import round-trip', () => {
  ...
  function exportData(transactions: Partial<Transaction>[], settings: Record<string, unknown> = {}): string {
  ...
  function importData(jsonString: string): { error?: string; transactions: Partial<Transaction>[]; settings?: Record<string, unknown> } {
    try {
      ...
      return { error: (e as Error).message, transactions: [] };
    }
  }
...
describe('toCents', () => {
  ...
  it('handles invalid input', () => {
    ...
    expect(toCents(null as unknown as number)).toBe(0);
  });
...
describe('addAmounts', () => {
  ...
  it('handles mixed string and number input', () => {
    expect(addAmounts('10.50' as unknown as number, 20, '5.25' as unknown as number)).toBe(35.75);
  });
...
describe('parseAmount', () => {
  ...
  it('returns 0 for invalid input', () => {
    ...
    expect(parseAmount(undefined as unknown as number)).toBe(0);
    expect(parseAmount(null as unknown as number)).toBe(0);
  });
